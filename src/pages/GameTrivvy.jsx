...
import GameTrivvyData from "../components/GameTrivvyData";
import "./Trivvy.css";

function GameTrivvy() {

    let questions = GameTrivvyData;
    ...
    return (
        <div className="musicTrivvy trivvyContainer">
            ...
            {/* Header */}
            <h1 className="trivvyHeader">GAME <span className="tag">TRIVVY!</span></h1>
