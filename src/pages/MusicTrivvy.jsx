...
import MusicTrivvyData from "../components/MusicTrivvyData";
import "./Trivvy.css";

function MusicTrivvy() {

    let questions = MusicTrivvyData;
    ...
    return (
        <div className="musicTrivvy trivvyContainer">
            ...
            {/* Header */}
            <h1 className="trivvyHeader">MUSIC <span className="tag">TRIVVY!</span></h1>
