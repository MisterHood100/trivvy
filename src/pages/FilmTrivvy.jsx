...
import FilmTrivvyData from "../components/FilmTrivvyData";
import "./Trivvy.css";

function FilmTrivvy() {

    let questions = FilmTrivvyData;
    ...
    return (
        <div className="musicTrivvy trivvyContainer">
            ...
            {/* Header */}
            <h1 className="trivvyHeader">FILM <span className="tag">TRIVVY!</span></h1>
