...
import AnimalTrivvyData from "../components/AnimalTrivvyData";
import "./Trivvy.css";

function AnimalTrivvy() {

    let questions = AnimalTrivvyData;
    ...
    return (
        <div className="animalTrivvy trivvyContainer">
        {/* Navigation */}
        <div className="trivvyNav">
            ...
            {/* Header */}
            <h1 className="trivvyHeader">ANIMAL <span className="tag">TRIVVY!</span></h1>
